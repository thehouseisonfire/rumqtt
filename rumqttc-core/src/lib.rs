...
impl Transport {
    ...
    pub fn tls_with_default_config() -> Self {
        Self::tls_with_config(TlsConfiguration::default_rustls())
    }

    #[cfg(all(feature = "use-native-tls", not(feature = "use-rustls-no-provider")))]
    #[must_use]
    pub fn tls_with_default_config() -> Self {
        Self::tls_with_config(TlsConfiguration::default_native())
    }
    ...
    pub fn wss_with_default_config() -> Self {
        Self::Wss(TlsConfiguration::default_rustls())
    }
    ...
    pub fn wss_with_default_config() -> Self {
        Self::Wss(TlsConfiguration::default_native())
    }
}
