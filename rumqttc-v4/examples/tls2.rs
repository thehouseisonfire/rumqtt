...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    //     let ca = include_bytes!("/home/user/tlsfiles/ca.cert.pem");
    //     let client_cert = include_bytes!("/home/user/tlsfiles/device-1.cert.pem");
    //     let client_key = include_bytes!("/home/user/tlsfiles/device-1.key.pem");
